...
export async function generateMetadata(
  ...
  const unit = getResearchUnits(locale).find(u => u.urlSlug === urlSlug )
...
const ResearchUnitPage = async ({ params }: ResearchUnitPageProps) => {
    ...
    const researchUnit = getResearchUnits(locale).find((item) => item.urlSlug === researchUnitUrlSlug)
